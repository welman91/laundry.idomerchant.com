...
export default function xxxxDataTable({
  collection,
  columns,
  ActionsButton,
  FilterButton,
  ...
  return (
    <div className="rounded-md shadow-lg overflow-hidden bg-white dark:bg-[#121E2E]">
      <header className="px-4 py-3 flex-start gap-4">
        ...
        {withSearch && (
          <div className="flex-grow">
            <SearchFunction searchFields={searchFields} />
          </div>
        )}
        ...
        {resetRouteRedirect && (
          <div className="flex-none">
            <Link
              ...
              className="font-semibold px-4 py-1 rounded-md button-shadow text-gray-600 dark:text-white dark:bg-[#0B1727] flex-start gap-1"
            >
              <BiReset />
              Reset
            </Link>
